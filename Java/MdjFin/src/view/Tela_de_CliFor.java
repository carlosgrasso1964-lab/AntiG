...
public class Tela_de_CliFor extends javax.swing.JFrame {
    ...
    private void adicionarListeners() {
        // Sugere c�digo autom�tico ao mudar tipo (s� quando N�O est� editando)
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("A��es"));
        ...
        tbDadosCliFor.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod", "Tipo", "Raz�o Social", "Nome Fantasia", "E-mail", "Celular", "Telefone", "CEP", "Endere�o", "Numero", "Bairro", "Complemento", "Cidade", "UF", "RG/IE", "CPF/CNPJ", "Contato", "Observa��o", "Vinculo"
            }
        ));
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        if (tfCodCliFor.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "C�digo obrigat�rio!");
            return;
        }
        ...
        if (gp == null && !tfConta.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Grupo Principal inv�lido!");
            return;
        }
        c.setFkCliForGp(gp);
    ...
    private void btAbrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAbrirActionPerformed
        ...
        if (cod.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Digite um c�digo para buscar.");
            return;
        }
        try {
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        int resp = JOptionPane.showConfirmDialog(this, "Tem certeza que deseja excluir?", "Confirma��o", JOptionPane.YES_NO_OPTION);
    ...
    public void listar() {
        try {
            ...
            // 2. S� REATIVA O SORTER DEPOIS DE TERMINAR TUDO
    ...
    private void jButtonImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonImprimirActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "Relat�rio de Favorecidos gerado com sucesso!");
            dispose();
