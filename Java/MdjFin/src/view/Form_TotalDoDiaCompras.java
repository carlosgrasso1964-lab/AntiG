...
public class Form_TotalDoDiaCompras extends javax.swing.JDialog {
    ...
    public Form_TotalDoDiaCompras(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
        setTitle("Total de Compras do Dia");
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        try {
            ...
            // Usa try-with-resources ? abre e fecha conexão automaticamente!
            try (Connection con = Conexao.faz_conexao()) {
                ComprasDAO dao = new ComprasDAO(con);
                double totalDoDia = dao.posicaoDoDia(data); // método que você já tem

                NumberFormat nf = NumberFormat.getCurrencyInstance(Locale.of("pt", "BR"));
                txtTotal.setText(nf.format(totalDoDia));

                JOptionPane.showMessageDialog(this,
                    "Total de COMPRAS em " + data.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + ":\n\n" +
                    nf.format(totalDoDia),
                    "Resultado do Dia", JOptionPane.INFORMATION_MESSAGE);
