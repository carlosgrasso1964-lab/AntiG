...
public class PainelDiarioController {
    ...
    public static RelatorioPainel gerarRelatorio(Date data, BigDecimal valorReserva) {
        ...
        try (Connection con = Conexao.faz_conexao();) {
            ...
            String sqlSaldo = "SELECT SUM(saldos) FROM view_saldos WHERE conta IN ('Bancos', 'Caixa')";
            ...
            // 4. Saldo Poupança
            String sqlPoup = "SELECT SUM(saldos) FROM view_saldos WHERE conta = 'Conta Poupança'";
