...
public class Tela_de_Consulta_Balance extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonGroup1.add(jRadioButtonVcto);
        jRadioButtonVcto.setText("Vencimento");

        buttonGroup1.add(jRadioButtonEmissao);
        jRadioButtonEmissao.setText("Emissão");

        buttonGroup1.add(jRadioButtonApresent);
        ...
        jPanelRegimeLayout.setVerticalGroup(
            jPanelRegimeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelRegimeLayout.createSequentialGroup()
        ...
        jLabel6.setText("CONSULTA  -  BALANÇO");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jButtonPImprimir, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButtonPLimpar, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButtonExportar, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButtonPFechar, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        try {
            ...
            // === SUA CONSULTA PRINCIPAL (POSTGRESQL) ===
            String sql = "SELECT nome_p AS Princ, nome_s AS Sub, "
                    ...
                    + "ELSE TRIM(nome_c) END AS Conta, "
                    + "CASE WHEN UPPER(TRIM(nomebco)) = 'CONTAS À RECEBER' THEN 'CONTAS À RECEBER' "
                    + "WHEN UPPER(TRIM(nome_c)) LIKE '%CONTAS À RECEBER%' THEN 'CONTAS À RECEBER' "
                    + "ELSE TRIM(nomebco) END AS Nome, "
                    ...
                    + "ELSE vrecurso END AS vrecurso, recurso, SUM(valor) AS Total "
                    + "FROM view_movimento WHERE COALESCE(prev, '') <> 'F' AND dtlancto <= ? "
                    + "AND TRIM(nome_c) <> 'Contas à Pagar' "
                    + "AND NOT (UPPER(TRIM(nomebco)) = 'CONTAS À PAGAR' AND TRIM(nome_c) NOT IN ('Contas à Pagar', 'Contas à Receber')) "
                    + "GROUP BY 1, 2, 3, 4, 5, 6 ORDER BY 1, 2, 5";
    ...
    private void jButtonPImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPImprimirActionPerformed
        ...
        MessageFormat cabecalho = new MessageFormat(tituloPadrao + " - " + dataInicial + " a " + dataFinal);
