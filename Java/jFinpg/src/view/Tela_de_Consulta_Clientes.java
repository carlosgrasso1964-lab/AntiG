...
public class Tela_de_Consulta_Clientes extends javax.swing.JFrame {
    CarregarCbx re = new CarregarCbx(); //Carrega combobox de Favorecidos
    public Tela_de_Consulta_Clientes() throws SQLException {
        initComponents();
    ...
    private void jButtonPFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPFecharActionPerformed
        try {
            ...
            Logger.getLogger(Tela_de_Consulta_Clientes.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        if (jFormattedTextFieldDataIni.getText().trim().length() == 4) {
            ...
            try {
                ...
                //double sa = Double.parseDouble(jTextFieldSaldoAnterior.getText().replaceAll(",", "."));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_de_Consulta_Clientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Tela_de_Consulta_Clientes().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Tela_de_Consulta_Clientes.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void PegaSaldoAnterior() {
        ...
        try {
            ...
            Logger.getLogger(Tela_de_Consulta_Fornecedores.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ParseException ex) {
            Logger.getLogger(Tela_de_Consulta_Fornecedores.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
