...
public class ImprimirJTable implements Printable {
    ...
    public ImprimirJTable(JTable tabela){
        ...
        //MessageFormat cabecalho = new MessageFormat("Relat√≥rio Previs√£o de Caixa - ");
        //MessageFormat rodape = new MessageFormat("P√°gina {0,number,integer}");
    ...
    /**
     * MÈtodo respons·vel pela impress„o da JTable
     * @param g
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException{
        ...
        // Deixe espa√ßo para o n˙mero da p√°gina
        ...
        } // caso contr√°rio, recorte para toda a √°rea dispon√≠vel.
        else {
            graphics2d.setClip(0,
                    (int) (pageHeightForTable * pageIndex),
                    (int) Math.ceil(tableWidthOnPage),
        ...
        //String s = "RELAT”RIO DE PREVIS√O DE CAIXA";
        ...
        //tabela.getTableHeader().paint(graphics2d);	// pintar cabe√ßalho no topo
