...
public class ProjetoDAO {
    ...
    public void criar(Projeto projeto) throws SQLException {
        ...
        try (Connection con = Conexao.faz_conexao(); PreparedStatement ps = con.prepareStatement(sql, PreparedStatement.RETURN_GENERATED_KEYS)) {
            ...
            ps.setString(2, dateToString(projeto.getDataInicioPrevista()));
            ps.setString(3, dateToString(projeto.getDataFimPrevista()));
            ps.setString(4, dateToString(projeto.getDataInicioRealizada()));
            ps.setString(5, dateToString(projeto.getDataFimRealizada()));
            ps.setString(6, projeto.getStatus());
            ps.setBigDecimal(7, projeto.getValorPrevistoTotal() != null ? projeto.getValorPrevistoTotal() : BigDecimal.ZERO);
            ps.setBigDecimal(8, projeto.getValorRealizadoTotal() != null ? projeto.getValorRealizadoTotal() : BigDecimal.ZERO);
