...
public class VCadCliFor extends javax.swing.JDialog {

    private final CliForDAO dao = new CliForDAO();
    private String editingCodCliFor = null;

    public VCadCliFor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        //configurarInternalFrame();
    ...
    //private void configurarInternalFrame() {
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanelCadFavLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelCadFavLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelCadFavLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(cbxConta, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanelCadFavLayout.createSequentialGroup()
                                    .addGroup(jPanelCadFavLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btnListarDados, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
...
//    }
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        ...
        c.setFkCliForGp(buscarGrupoPrincipal(tfConta.getText().trim()));
    ...
    private Placon buscarGrupoPrincipal(String cod) {
        if (cod == null || cod.trim().isEmpty()) return null;
        try {
            return dao.buscarGrupoPrincipal(cod.trim());
        } catch (SQLException ex) {
            Logger.getLogger(VCadCliFor.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    }
    ...
    private void jButtonImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonImprimirActionPerformed
        try {
            ...
            dispose();
            //new VCadCliFor().setVisible(true);
