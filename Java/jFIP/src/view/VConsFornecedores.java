 ...
 * @author CARLOS
 */
public class VConsFornecedores extends javax.swing.JInternalFrame {
    CarregarCbx re = new CarregarCbx(); //Carrega combobox de Favorecidos
    /**
     * Creates new form VConsFornecedores
     */
    public VConsFornecedores() throws SQLException {
        initComponents();
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        if (jFormattedTextFieldDataIni.getText().trim().length() == 4) {
            ...
            try {
                ...
                jTablePesquisa.getColumn(jTablePesquisa.getColumnName(10)).setPreferredWidth(358); //Descr
                jTablePesquisa.getColumn(jTablePesquisa.getColumnName(11)).setPreferredWidth(80);  //Valor
                jTablePesquisa.getColumn(jTablePesquisa.getColumnName(12)).setPreferredWidth(90); //dtApr
            ...
            Logger.getLogger(VConsFornecedores.class.getName()).log(Level.SEVERE, null, ex);
        }
        }
