 ...
 * @author CARLOS
 */
public class VConsClass extends javax.swing.JInternalFrame {
    CarregarCbx3 r3 = new CarregarCbx3(); //Carrega combobox de Classificação por Conta    
    /**
     * Creates new form VConsClass
     * @throws java.sql.SQLException
     */
    public VConsClass() throws SQLException {
        initComponents();
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tfClass, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        if (jFormattedTextFieldDataIni.getText().trim().length() == 4) {
            ...
            try {
                ...
                jTablePesquisa.getColumn(jTablePesquisa.getColumnName(10)).setPreferredWidth(385); //Descr
                ...
                jTablePesquisa.getColumn(jTablePesquisa.getColumnName(13)).setPreferredWidth(30); //statusMov
                jTablePesquisa.getColumn(jTablePesquisa.getColumnName(14)).setPreferredWidth(30); //Prev
                jTablePesquisa.getColumn(jTablePesquisa.getColumnName(15)).setPreferredWidth(100); //Saldo
            ...
            Logger.getLogger(VConsClass.class.getName()).log(Level.SEVERE, null, ex);
        }
        }
