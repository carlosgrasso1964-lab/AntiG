...
//    private CliFor buscarClienteSelecionado() {
//        if (cbxClientes.getSelectedItem() == null) {
//            return new CliFor(); // cliente genérico ou avulso
//        }
//
//        try {
//            String texto = cbxClientes.getSelectedItem().toString();
//            String idStr = texto.substring(texto.lastIndexOf(" | ") + 1).trim();
//            int id = Integer.parseInt(idStr);
//
//            CliForDAO dao = new CliForDAO();
//            CliFor cliente = dao.buscarPorId(id);
//
//            return cliente != null ? cliente : new CliFor(); // fallback
//
//        } catch (Exception e) {
//            System.out.println("Cliente não encontrado, prosseguindo como avulso.");
//            return new CliFor(); // venda avulsa
//        }
//
//    }
    ...
    private void cbxClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxClientesActionPerformed
        ...
        String idCliente = partes[1].trim();  // ? "1002"
        ...
        // AQUI É A MÁGICA: PREENCHE O OBJETO CLIENTE COM OS DADOS QUE VOCÊ JÁ TEM!
        clientes = new CliFor();
        clientes.setCodCliFor(idCliente);           // ? ESSA LINHA SALVA TUDO!
        clientes.setNomeCliFor(nomeCliente);
        // clientes.setCpfCnpj(documento.replaceAll("\\D", "")); // opcional

        //System.out.println("Cliente selecionado e ASSOCIADO:");
        //System.out.println(" Nome: " + nomeCliente);
        //System.out.println(" ID: " + idCliente);
        //System.out.println(" Documento: " + documento);
        //System.out.println("? Cliente com codCliFor = " + clientes.getCodCliFor() + " será salvo na venda!");
    }
