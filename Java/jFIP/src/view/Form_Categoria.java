...
public class Form_Categoria extends JDialog {
    ...
    private CategoriaDAO dao;
        ...
        public Form_Categoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
...
try {
            ...
            try {
                ...
                if (multiplicador < 0) throw new NumberFormatException();
