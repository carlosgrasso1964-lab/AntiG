 ...
 * @author Usuário
 */
public class Form_Etapas extends javax.swing.JInternalFrame {
     ...
     */
    public Form_Etapas() throws SQLException {
        initComponents();
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtVrReal, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtFimEtapaReal, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtFimEtapaPrev, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        try {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this,
                        "Uma das datas está no formato inválido!\nUse dd/MM/yyyy (ex: 25/12/2025)",
            ...
            if (vrPrev == null || vrReal == null) {
                JOptionPane.showMessageDialog(this,
                        "Valor Previsto e Realizado devem ser números válidos (ex: 15000,50)",
...
//        }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        try {
            ...
            // Cria uma instância temporária só para passar ao DAO
            Conexao conexao = new Conexao();
            EtapaDAO etapaDAO = new EtapaDAO(conexao);

            etapaDAO.deletar(id); // A conexão é aberta e fechada automaticamente dentro do deletar()
            ...
            ex.printStackTrace(); // Opcional: para debug no console
        }
...
//        });
        ...
        //java.awt.EventQueue.invokeLater(() -> new Form_Etapas().setVisible(true));
        // });
    }
