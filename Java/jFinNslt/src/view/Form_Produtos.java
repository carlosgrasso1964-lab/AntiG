...
public class Form_Produtos extends javax.swing.JDialog {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            ...
            // ? Capturar e formatar o preço corretamente
            ...
            double preco = Double.parseDouble(precoStr); // Converter para double

            obj.setPreco(preco); // Salvar preço corretamente

            obj.setPrecoMedioCusto(preco);
            ...
            obj.setQtd_estoque(Double.parseDouble(txtQtdEstoque.getText().replace(",", ".")));

            obj.setQtd_estoqueMinimo(Double.parseDouble(txtQtdEstoqueMinimo.getText().replace(",", ".")));

            obj.setQtd_estoqueMaximo(Double.parseDouble(txtQtdEstoqueMaximo.getText().replace(",", ".")));



            // ? Configurar fornecedor e categoria

            String nomeFornecedor = cbFornecedor.getSelectedItem().toString();

            CliForDAO daoFornecedor = new CliForDAO();

            CliFor fornecedor = daoFornecedor.BuscarFornecedor(nomeFornecedor);

            obj.setCliFor(fornecedor);



            String nomeCategoria = cbCategorias.getSelectedItem().toString();

            CategoriaDAO daoCategoria = new CategoriaDAO();

            Categoria categoria = daoCategoria.BuscarCategoriaPorNome(nomeCategoria);
            ...
            obj.setPrecoVenda(Double.parseDouble(txtPrecoVd.getText()));
            ...
            dao.Salvar(obj); // Método que insere no banco
            ...
            JOptionPane.showMessageDialog(null, "Erro no formato dos números: " + e.getMessage());
    ...
    private String formatarValor(String valor) {
        ...
        // Remove espaços extras e númeross inválidos
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        if (linhaSelecionada >= 0) {
            ...
            try {
                ...
                txtDescricao.setText(tabela.getValueAt(linhaSelecionada, 1).toString());



                // Qtd. Estoque

                String qtdEstoqueStr = tabela.getValueAt(linhaSelecionada, 2).toString().replace(".", "").replace(",", ".");

                txtQtdEstoque.setText(qtdEstoqueStr);



                // Fornecedor

                String fornecedorNome = tabela.getValueAt(linhaSelecionada, 3).toString();

                for (int i = 0; i < cbFornecedor.getItemCount(); i++) {

                    if (cbFornecedor.getItemAt(i).toString().equalsIgnoreCase(fornecedorNome)) {
                ...
                String estoqueMinimoStr = tabela.getValueAt(linhaSelecionada, 4).toString().replace(".", "").replace(",", ".");

                txtQtdEstoqueMinimo.setText(estoqueMinimoStr);



                // Estoque Máximo

                String estoqueMaximoStr = tabela.getValueAt(linhaSelecionada, 5).toString().replace(".", "").replace(",", ".");

                txtQtdEstoqueMaximo.setText(estoqueMaximoStr);



                // Preço Médio Custo

                String precoCustoStr = tabela.getValueAt(linhaSelecionada, 6).toString().replace("R$", "").replace(".", "").replace(",", ".");

                txtPreco.setText(precoCustoStr);



                // Preço Venda

                String precoVendaStr = tabela.getValueAt(linhaSelecionada, 7).toString().replace("R$", "").replace(".", "").replace(",", ".");

                txtPrecoVd.setText(precoVendaStr);



                // Categoria

                int categoriaId = Integer.parseInt(tabela.getValueAt(linhaSelecionada, 8).toString());

                CategoriaDAO daoCategoria = new CategoriaDAO();

                String categoriaNome = daoCategoria.buscarNomeCategoria(categoriaId);



                for (int i = 0; i < cbCategorias.getItemCount(); i++) {

                    if (cbCategorias.getItemAt(i).toString().equalsIgnoreCase(categoriaNome)) {
                ...
                JOptionPane.showMessageDialog(this, "Erro ao selecionar produto: " + e.getMessage());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            ...
            // ? Capturar e formatar preço corretamente
            ...
            obj.setPreco(preco); // Define o preço de custo
            ...
            // ? Depuração para verificar a categoria

            //System.out.println("Categoria selecionada: " + nomeCategoria);

            //System.out.println("Categoria carregada: " + (categoria != null ? categoria.getNome() : "NULA"));

            //System.out.println("Multiplicador carregado: " + (categoria != null ? categoria.getMultiplicador() : "NULO"));
            ...
            if (categoria != null && categoria.getMultiplicador() != null) {
                ...
                //System.out.println("Preço de custo (antes do cálculo): " + obj.getPrecoMedioCusto());

                //System.out.println("Multiplicador da categoria (antes do cálculo): " + categoria.getMultiplicador());

                obj.setPrecoMedioCusto(preco); // Define precoMedioCusto com o preço capturado

                //System.out.println("Preço de custo definido: " + obj.getPrecoMedioCusto());
                ...
                ///System.out.println("Preço de venda final: " + obj.getPrecoVenda());

            } else {

                JOptionPane.showMessageDialog(null, "Categoria ou multiplicador não foram encontrados. Verifique no banco de dados.");

                return; // Sai do método se não conseguir calcular

            }



            // ? Depuração para verificar o preço de venda

            //System.out.println("Preço de custo: " + preco);

            //System.out.println("Multiplicador: " + categoria.getMultiplicador());

            //System.out.println("Preço de venda calculado: " + obj.getPrecoVenda());
    ...
    public static double parseStringToDouble(String valor) throws ParseException {
        ...
        // Remove o números de moeda e os espaços
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        try {
            ...
            obj.setDescricao(daop.buscarDescricaoPorId(obj.getId())); // Busca a descrição pelo ID
    ...
    private void txtDescricaoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescricaoKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) { // Verifica se a tecla ENTER foi pressionada
            ...
            try {
                ...
                obj = dao.BuscarProdutos(nome); // Busca o produto pelo nome
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Fechar a conexão com o banco de dados, se aberta
