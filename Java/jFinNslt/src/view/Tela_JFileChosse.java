...
public class Tela_JFileChosse extends javax.swing.JFrame {

    public Tela_JFileChosse() {
        initComponents();
    }
    ...
    private void btnArquivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnArquivoActionPerformed
        ...
        if (retorno == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                Logger.getLogger(Tela_JFileChosse.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_JFileChosse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Tela_JFileChosse().setVisible(true);
        });
    }
