...
public class Tela_Consulta_Invest extends javax.swing.JFrame {
    ...
    public Tela_Consulta_Invest() throws SQLException {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("CONSULTA - INVESTIMENTOS");
    ...
    private void jButtonPFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPFecharActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Tela_Consulta_Invest.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        if (jFormattedTextFieldDataIni.getText().trim().length() == 4) {
            ...
            try {
                ...
                String sql = "SELECT * FROM tbmovimento WHERE dtEmi BETWEEN ? AND ? AND vCliFor = ? ORDER BY dtEmi";
    ...
    private void jButtonPImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPImprimirActionPerformed
        ...
        MessageFormat cabecalho = new MessageFormat("Relatório de Consulta - Investimentos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Consulta_Invest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    new Tela_Consulta_Invest().setVisible(true);
