...
public class Form_TotalDoDiaVendas extends javax.swing.JDialog {
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        try {
            ...
            total_do_dia = dao_v.posicaoDoDia(data); // Certifique-se que esse método lança SQLException e ClassNotFoundException
            ...
            Logger.getLogger(Form_TotalDoDiaVendas.class.getName()).log(Level.SEVERE, "Formato de data inválido!", ex);

            JOptionPane.showMessageDialog(null, "Formato de data inválido! Use dd/MM/yyyy.");

        } catch (SQLException | ClassNotFoundException ex) {

            Logger.getLogger(Form_TotalDoDiaVendas.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_TotalDoDiaVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
